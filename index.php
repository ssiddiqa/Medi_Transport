            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div
                        ...
                        <a href="home.php" target="_blank"
                            class="btn btn-outline-white shadow-lg text-black m-3 p-3 rounded-3"
                ...
                <div class="col-lg-4 col-md-6">
                    <div
                        ...
                        <a href="homee.php" target="_blank"
                            class="btn btn-outline-white shadow-lg text-black m-3 p-3 rounded-3"
                            style="background-color:#13C5DD">Find
                            Schedule</a>
                    </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-light mb-2" href="index.php#about"><i
                                    class="fa fa-angle-right me-2"></i>About
                                Us</a>
                            <a class="text-light mb-2" href="index.php#service"><i
